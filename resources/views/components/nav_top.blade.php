...
float: right;
font-size: 16px;">
        <a href="#" class="btn btn-danger square-btn-adjust">Se déconnecter</a>
    </div>
</nav>
<!-- /. NAV TOP  -->
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <h5 style="color: white;" class="text-center">Admin</h5>
            </li>
            ...
            <li>
                <a href="{{ route('dashboard_car') }}"><i class="fa-solid fa-car fa-2x" style="color: #ffffff;"></i>
                   Données de véhicule<span class="fa arrow"></span></a>
            ...
            <li>
                <a class="" href="{{ route('dashboard_order') }}">
                    <i class="fa fa-users fa-2x"></i>Commandes</a>
            </li>
            <li>
